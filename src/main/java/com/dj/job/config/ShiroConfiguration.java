...
public class ShiroConfiguration {
    ...
    ShiroFilterFactoryBean shiroFilterFactoryBean(SecurityManager securityManager) {
        ...
        filters.put("/user/findByName", "anon");
        filters.put("/user/findByPhone", "anon");
        filters.put("/user/findByEmail", "anon");
        filters.put("/user/addUser", "anon");
        filters.put("/user/toActivate/**", "anon");
        filters.put("/user/updateStatusByEmail", "anon");
//      authc 表示必须认证才可访问
        filters.put("/**", "authc");
